...
## Leyes (morado)
- Caja info: datos reales del Senado (junio 2026), voto por legislador no público.
- Caja "¿Cómo funciona?".
- Leyenda de estados: Aprobada / En votación / Rechazada.
- Acordeón "¿Por qué no veo quién votó?" + sectores.
- Estado: limpio.
